...
public class TeamActivity extends AppCompatActivity {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_dashboard:
                    Intent intent2=new Intent(TeamActivity.this,HomeScreen.class);
                    startActivity(intent2);
                    break;
                case R.id.navigation_notifications:
                    Intent intent3=new Intent(TeamActivity.this,Notification.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Blog, TeamActivity.BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Blog, TeamActivity.BlogViewHolder>
                (Blog.class, R.layout.cardview, TeamActivity.BlogViewHolder.class, mDatabase) {
            @Override
            protected void populateViewHolder(TeamActivity.BlogViewHolder viewHolder, Blog model, int position) {
